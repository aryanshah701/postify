...
export class Initial1621123319199 implements MigrationInterface {
    name = 'Initial1621123319199'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "comment" ("id" SERIAL NOT NULL, "postId" integer NOT NULL, "userId" integer NOT NULL, "parentId" integer, "text" character varying NOT NULL, "depth" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c8e6fa847cbcca402f8bac3c9d9" PRIMARY KEY ("id", "postId", "userId"))`);
